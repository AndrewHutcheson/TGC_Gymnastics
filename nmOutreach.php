...
<? 
	require("auth.php");
	require('globals.php');
	require('mapHelperFunctions.php');
...
{	
	...
	$sqlClubs = "
				...
				WHERE
					Identifiers_Programs.ClubType IN (2,3,10,12,13) AND
...
?>
  ...
  <script>		
		...
		jQuery(function($) {
			...
			script.src = "https://maps.googleapis.com/maps/api/js?sensor=false&callback=initialize&libraries=geometry&key=AIzaSyAiFMcKbv4UrgEc8vo1L4uySGRKIRF3Nv8";
   ...
   <script>
		...
		function initialize() {
			...
			var mapOptions = {
				center: new google.maps.LatLng(34.5199, -105.8701),
				zoom:6,
				mapTypeId: 'roadmap'
			};
